...
class SearchEngine:
    ...
    def calculate_relevance_score(self, query: str, content: str, 
                                 matches: List[Dict], metadata: DocumentMetadata) -> float:
...
class DocumentAnalyzer:
    ...
    def analyze_document(content: str, metadata: DocumentMetadata) -> Dict[str, Any]:
        ...
        analysis['structure'] = {
            ...
            'code_languages': list(set(cb['language'] for cb in code_blocks)),
...
async def process_files_parallel(file_paths: List[Path], 
                                processor_func, 
