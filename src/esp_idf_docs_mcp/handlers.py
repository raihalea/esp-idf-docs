...
Returns: Ranked list of recommended documents with descriptions and metadata.""",
    ...
    def _handle_validation_error(self, error: ValueError, name: str, 
    ...
    def _handle_internal_error(self, error: Exception, name: str, 
                              operation_start: float) -> List[TextContent]:
